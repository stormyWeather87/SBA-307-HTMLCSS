...
(function (_w, _s) {
    ...
    app = {
        ...
        betaAccounts:[172084, 173448, 108508, 173345, 175092, 167283, 169430, 108422, 168814, 185532],
        beta: {
        ...
        getReferrer: function() {
            ...
            if (depth === 0) {
                ...
                referrer = document.location.ancestorOrigins[document.location.ancestorOrigins.length - 1];
            }
            if (typeof referrer === 'string' && referrer.startsWith("data:", 0)) {
                _logMessage("Referrer: Detected data URL, ignoring ");
                referrer = false;
            }
            return referrer;
        },
        ...
        buildRequest: function(account, zone, size, div, opt) {
            ...
            if (opt.click_url && opt.click_url.length)
                request.redirect.click_url = encodeURIComponent(opt.click_url);
